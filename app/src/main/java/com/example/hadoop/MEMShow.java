...
//    private Spinner spinner;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.layout_mem);
        initLayout();
        System.out.println("layout finish");
        initSpeech();
        System.out.println("speech finish");
        initViews(null);
    }
                ...
                switch (msg.what){
                    case ADD_VIEW:
                        ...
                        for(graphData g : mGraphDatas){
                            //获取chartview
                            gv=ChartFactory.getTimeChartView(MEMShow.this,g.getDataSet(),g.getRenderer(),g.getFormat());
                            System.out.println(5+6);
                            //更新UI
                            layout.addView(gv,LinearLayout.LayoutParams.MATCH_PARENT, 1200);
                        }
            ...
            if(!b){
                ...
                switch (rat){
                    ...
                    case JsonPraser.MAIN_FLAG:
                        intent=new Intent(MEMShow.this,MainActivity.class);
                        startActivity(intent);
                        break;
                    //cpu
                    case JsonPraser.CPU_FLAG:
                        intent=new Intent(MEMShow.this,CPUShow.class);
                        startActivity(intent);
                        break;
                    //mem
                    ...
                    case JsonPraser.LOAD_FLAG:
                        intent=new Intent(MEMShow.this,LOADShow.class);
                        startActivity(intent);
                        break;
                    //network
                    case JsonPraser.NETWORK_FLAG:
                        intent=new Intent(MEMShow.this,NETWORKShow.class);
                        startActivity(intent);
                        break;
                    //disk
...
//                        break;
                    ...
                    case JsonPraser.REC_ERROR:
                        Toast.makeText(MEMShow.this,"识别错误",Toast.LENGTH_SHORT).show();
                        break;
                    //刷新
