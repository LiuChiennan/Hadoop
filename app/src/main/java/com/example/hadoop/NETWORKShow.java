...
public class NETWORKShow extends AppCompatActivity implements myPara,View.OnClickListener{
...
//    private Spinner spinner;
    ...
    private void initLayout(){
        //初始化语音服务
        SpeechUtility.createUtility(NETWORKShow.this,SpeechConstant.APPID+"="+JsonPraser.MAPPID);
        fab=(FloatingActionButton)findViewById(R.id.fab);
        //设置到最顶层
        fab.bringToFront();
        fab.setOnClickListener(this);
        mToast=Toast.makeText(NETWORKShow.this,"",Toast.LENGTH_SHORT);
        layout=(LinearLayout)findViewById(R.id.network);
                ...
                switch (msg.what){
                    case ADD_VIEW:
                        ...
                        for(graphData g : mGraphDatas){
                            //获取chartview
                            gv=ChartFactory.getTimeChartView(NETWORKShow.this,g.getDataSet(),g.getRenderer(),g.getFormat());
                            //更新UI
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.dec_node:
                ...
                break;
            case R.id.menu_cpu:
                startActivity(new Intent(NETWORKShow.this,CPUShow.class));
                break;
            case R.id.menu_mem:
                startActivity(new Intent(NETWORKShow.this,MEMShow.class));
                break;
            case R.id.menu_network:
                startActivity(new Intent(NETWORKShow.this,NETWORKShow.class));
                break;
            case R.id.menu_load:
                startActivity(new Intent(NETWORKShow.this,LOADShow.class));
                break;
            case R.id.refresh:
                mGraphDatas.clear();
...
//        System.out.println("test"+para);
        ...
        renderer.setYTitle("Kbytes/secs");
        // 设置标题
        renderer.setChartTitle("network in the last "+title);
        // 设置Y轴最大值,也是各个metric不同的地方
        renderer.setYAxisMax(chartService.manageYlabel(40000));
            ...
            if(!b){
                ...
                switch (rat){
                    ...
                    case JsonPraser.MAIN_FLAG:
                        intent=new Intent(NETWORKShow.this,MainActivity.class);
                        startActivity(intent);
                        break;
                    //cpu
                    case JsonPraser.CPU_FLAG:
                        intent=new Intent(NETWORKShow.this,CPUShow.class);
                        startActivity(intent);
                        break;
                    //mem
                    case JsonPraser.MEM_FLAG:
                        intent=new Intent(NETWORKShow.this,MEMShow.class);
                        startActivity(intent);
                        break;
                    //load
                    case JsonPraser.LOAD_FLAG:
                        intent=new Intent(NETWORKShow.this,LOADShow.class);
                        startActivity(intent);
                        break;
                    //network
...
//                        break;
                    ...
                    case JsonPraser.REC_ERROR:
                        Toast.makeText(NETWORKShow.this,"识别错误",Toast.LENGTH_SHORT).show();
                        break;
                    //刷新
